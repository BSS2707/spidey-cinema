...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Spidey Cinema — Book Movie Tickets" },
      { property: "og:description", content: "Premium movie ticket booking with a cinematic, immersive experience. Now showing the biggest blockbusters." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Spidey Cinema — Book Movie Tickets" },
      { name: "twitter:description", content: "Premium movie ticket booking with a cinematic, immersive experience. Now showing the biggest blockbusters." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/krXgkZSf5hMCa97Gx0LH8EPok9K2/social-images/social-1780856365545-logo.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/krXgkZSf5hMCa97Gx0LH8EPok9K2/social-images/social-1780856365545-logo.webp" },
    ],
    links: [
